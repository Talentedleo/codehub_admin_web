...
<el-input v-model="searchMap.jobname" placeholder="职位名称"></el-input></el-form-item>
  ...
  <el-table
    ...
    style="width: 100%">
          ...
          <el-table-column prop="conditions" label="经验要求"></el-table-column>
  ...
  <el-dialog title="编辑" :visible.sync="dialogFormVisible">
    <el-form label-width="80px">
        ...
        <el-form-item label="经验要求"><el-input v-model="pojo.conditions"></el-input></el-form-item>
...
export default {
  ...
  created() {
    this.fetchData(),
    //给企业列表赋值
    enterpriseApi.getList().then(res => {
