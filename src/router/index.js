    ...
    children: [
      {
        path: 'enterprise',
        name: 'Enterprise',
        component: () => import('@/views/recruit/enterprise'),
...

  {
    ...
    children: [
      { 
        path: 'channel', 
        name: 'channel', 
        component: () => import('@/views/article/channel'), 
        meta: { title: '频道管理', icon: 'table' }},
      { 
        path: 'column', 
        name: 'column', component: () => import('@/views/article/column'), 
        meta: { title: '专栏审核', icon: 'table' }},
      { 
        path: 'article', 
        name: 'article', component: () => import('@/views/article/article'), 
